...
function [calfExtension,V,e] = getExtension(CleatPosition, theta, alpha, omega,UpperLeg,LowerLeg,FootSize,FootHeight,CrankLength,PivotPosition,FootOffset,f1,plot)
    [psi,ankle,e] = getAngles(CleatPosition, theta, alpha,UpperLeg,LowerLeg,FootSize,FootHeight,CrankLength,PivotPosition,FootOffset,f1,plot);
    if e>0
        psi =0;
        calfExtension = 0;
        V =0;
